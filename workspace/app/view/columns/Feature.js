...
Ext.define('VBI.Workspace.view.columns.Feature', {
	...
	items: [
		...
		{text:'Genome Browser',			id:'Feature_',					dataIndex:'',					flex:1, hidden:true, sortable: false, renderer:renderGenomeBrowserByFeature},
		...
		{text:'Protein ID',				id:'Feature_refseq_protein_id',	dataIndex:'protein_id',			flex:1, hidden:true, renderer:BasicRenderer},
		{text:'Length (AA)',			id:'Feature_aa_length',			dataIndex:'aa_length',			flex:1, hidden:true, align:'right', renderer:BasicRenderer},
		{text:'Anticodon',				id:'Feature_anticodon',			dataIndex:'anticodon',			flex:1, hidden:true},
		{text:'Product Description',	id:'Feature_product',			dataIndex:'product',			flex:4, align:'left', renderer:BasicRenderer},
		{text:'Bound Moiety',			id:'Feature_bound_moiety',		dataIndex:'bound_moiety',		flex:1, hidden:true}
	]
});
