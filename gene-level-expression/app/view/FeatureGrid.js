...
Ext.define('CoordView.view.FeatureGrid', {
	...
	columns: [
		...
		{dataIndex: 'exp_name',			header: 'Exp Name',		flex: 3},
		{dataIndex: 'exp_strain',		header: 'Strain',		flex: 1},
		{dataIndex: 'exp_mutant',		header: 'Mutant',		flex: 1},
		{dataIndex: 'exp_condition',	header: 'Condition',	flex: 1},
